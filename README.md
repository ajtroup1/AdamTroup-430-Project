...
## Table of Contents
- [Overview](#overview)
- [Types of DocMate comments](#types-of-docmate-comments)
- [Generating documentation with DocMate](#generating-documentation-with-docmate)
- [Settings](#settings)

## Overview

*An example of documentation that was actually generated by DocMate can be found in `/docs/My Project.md` in this repository*
...
1. `make save` will no to be ran if you have no `settings.json` in the relative folder (generated by DocMate)
    - You will need to run `make save` and other Makefile commands in the root dir (`repo\AdamTroup-430-Project`)
2. After the `settings.json` is generated, you can specify a handful of settings, such as the path to your project, where to generate the documentation and more
3. After you have directed DocMate to your project, run `make save` to generate a heirarchal strcuture of your comments in a json file `godoc_output.json`. Here, you can view the raw data from your comments that will be generated into documentation
